...
function getNews($toponly=false)
{
	...
	$b.=news("2006-09-01","0.1.9 finally released","After a long wait, 0.1.9 was finally released today. You can get it at <a href='http://developer.berlios.de/project/showfiles.php?group_id=3474'>download link</a>. For more information go here:<a href='http://antargis.berlios.de/phpBB2/viewtopic.php?t=115'>Forum-news</a>. Instructions on how to install it can be found here: <a href='http://antargis.berlios.de/index.php?page=download'>Download-page</a>");
