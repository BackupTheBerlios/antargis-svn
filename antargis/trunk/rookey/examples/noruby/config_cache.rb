...
@hash{\"CC\"/usr/bin/gcc\"SWIG_OPTIONS\" -Wall -DAGEXPORT\"CCACHE\"/opt/local/bin/ccache\"	SWIG\" /opt/local/bin/swig\"CPP\"/usr/bin/g++\"CFLAGS\"V -arch ppc -arch i386 -Os -pipe -fno-common -O0 -g -D_GNU_SOURCE=1 -D_THREAD_SAFE\"host_os\"darwin9.0\"
