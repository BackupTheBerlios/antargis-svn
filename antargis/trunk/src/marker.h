...
%exception AntargisView::AntargisView {
	$action
	result->mRUBY=self;
  result->mRubyObject=true;
	printf("register:AntargisView\n");
}
%markfunc AntargisView "AGWidget_markfunc"
...
%markfunc AGVTiler "AGWidget_markfunc"
...
%markfunc AGHTiler "AGWidget_markfunc"
